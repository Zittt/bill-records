/**
 * Created by zwj9044 on 2017/2/8.
 */
/**
 * jQuery EasyUI 1.5
 *
...
(function ($)
{
    ...
    $.parser =
    {
        auto : true, onComplete : function (_b) {}, plugins : ["draggable", "droppable", "resizable",
        "pagination", "tooltip", "linkbutton", "menu", "menubutton", "splitbutton", "switchbutton", "progressbar",
        "tree", "textbox", "passwordbox", "filebox", "combo", "combobox", "combotree", "combogrid", "combotreegrid",
        "numberbox", "validatebox", "searchbox", "spinner", "numberspinner", "timespinner", "datetimespinner",
        "calendar", "datebox", "datetimebox", "slider", "layout", "panel", "datagrid", "propertygrid",
...
(function ($)
{
        ...
        return this.each(function ()
        {
            ...
            _5b.unbind(".draggable").bind("mousemove.draggable", {
                ...
                function (e)
                {
                    ...
                    var _60 =
                    {
                        startPosition : $(e.data.target).css("position"), startLeft : _5e.left, startTop : _5e.top,
                        left : _5e.left, top : _5e.top, startX : e.pageX, startY : e.pageY, width : $(e.data.target).outerWidth(),
                        height : $(e.data.target).outerHeight(), offsetWidth : (e.pageX - _5f.left), offsetHeight : (e.pageY - _5f.top),
    ...
    {
        proxy : null, revert : false, cursor : "move", deltaX : null, deltaY : null, handle : null, disabled : false,
        edge : 0, axis : null, delay : 100, onBeforeDrag : function (e) {}, onStartDrag : function (e) {},
        onDrag : function (e) {}, onStopDrag : function (e) {}
    };
    $.fn.draggable.isDragging = false;
})(jQuery);
(function ($)
{
    ...
    $.fn.droppable = function (_6e, _6f)
    {
        ...
        return this.each(function ()
        {
            ...
            else
            {
                ...
                $.data(this, "droppable",
                    {
                        options : $.extend({}, $.fn.droppable.defaults, $.fn.droppable.parseOptions(this),
                            _6e)
                    });
            }
        });
    ...
    {
        accept : null, disabled : false, onDragEnter : function (e, _72) {}, onDragOver : function (e,
                                                                                                    _73) {}, onDragLeave : function (e, _74) {}, onDrop : function (e, _75) {}
    };
})(jQuery);
(function ($)
{
        ...
        return this.each(function ()
        {
            ...
            $(this).bind("mousemove.resizable", {
                ...
                function (e)
                {
                    ...
                    var _86 =
                    {
                        target : e.data.target, dir : dir, startLeft : _85("left"), startTop : _85("top"),
                        left : _85("left"), top : _85("top"), startX : e.pageX, startY : e.pageY, startWidth : $(e.data.target).outerWidth(),
                        startHeight : $(e.data.target).outerHeight(), width : $(e.data.target).outerWidth(),
                        height : $(e.data.target).outerHeight(), deltaWidth : $(e.data.target).outerWidth() - $(e.data.target).width(),
    ...
    {
        disabled : false, handles : "n, e, s, w, ne, se, sw, nw, all", minWidth : 10, minHeight : 10,
        maxWidth : 10000, maxHeight : 10000, edge : 5, onStartResize : function (e) {},
        onResize : function (e) {}, onStopResize : function (e) {}
    };
    $.fn.resizable.isResizing = false;
})(jQuery);
(function ($)
{
    function _8e(_8f, _90)
    {
        ...
        if (_91.width || _91.height || _91.fit)
        {
            ...
            if (!_93)
            {
                ...
                var _95 = {
                    position : btn.css("position"), display : btn.css("display"), left : btn.css("left")
                };
                btn.appendTo("body");
                btn.css({
                    position : "absolute", display : "inline-block", left :- 20000
                });
            }
            btn._size(_91, _92);
        ...
        return this.each(function ()
        {
            ...
            else
            {
                $.data(this, "linkbutton",
                    {
                        options : $.extend({}, $.fn.linkbutton.defaults, $.fn.linkbutton.parseOptions(this),
                            _a5)
                    });
    ...
    {
        var t = $(_aa);
        return $.extend({}, $.parser.parseOptions(_aa, ["id", "iconCls", "iconAlign", "group", "size",
                "text", {
                    plain : "boolean", toggle : "boolean", selected : "boolean", outline : "boolean"
                }]),
            {
                disabled : (t.attr("disabled") ? true : undefined), text : ($.trim(t.html()) || undefined),
                iconCls : (t.attr("icon") || t.attr("iconCls"))
            });
    };
    $.fn.linkbutton.defaults =
    {
        id : null, disabled : false, toggle : false, selected : false, outline : false, group : null,
        plain : false, text : "", iconCls : null, iconAlign : "left", size : "small", onClick : function () {}
    };
})(jQuery);
(function ($)
{
    ...
    {
        total : 1, pageSize : 10, pageNumber : 1, pageList : [10, 20, 30, 50], loading : false, buttons : null,
        showPageList : true, showRefresh : true, links : 10, layout : ["list", "sep", "first", "prev",
        "sep", "manual", "sep", "next", "last", "sep", "refresh"], onSelectPage : function (_d1, _d2) {},
        onBeforeRefresh : function (_d3, _d4) {}, onRefresh : function (_d5, _d6) {},
        onChangePageSize : function (_d7) {}, beforePageText : "Page", afterPageText : "of {pages}", displayMsg : "Displaying {from} to {to} of {total} items",
        nav :
        {
            first :
            {
...
(function ($)
{
    ...
    function _15d(_15e, _15f)
    {
        ...
        _158(_15e, {
            parent : (_160 ? _160.target : null), data : data
        });
    ...
    $.fn.tree = function (_19e, _19f)
    {
        ...
        return this.each(function ()
        {
            ...
            else
            {
                ...
                $.data(this, "tree", {
                    options : opts, tree : _df(this), data : [], tmpIds : []
                });
    ...
    $.fn.tree.defaults =
    {
        url : null, method : "post", animate : false, checkbox : false, cascadeCheck : true, onlyLeafCheck : false,
        lines : false, dnd : false, data : null, queryParams : {},
        ...
        loader : function (_1cc, _1cd, _1ce)
        {
            ...
            $.ajax(
                {
                    type : opts.method, url : opts.url, data : _1cc, dataType : "json",
        ...
        view : _1c0, onBeforeLoad : function (node, _1d0) {}, onLoadSuccess : function (node, data) {},
        onLoadError : function () {}, onClick : function (node) {}, onDblClick : function (node) {},
        onBeforeExpand : function (node) {}, onExpand : function (node) {}, onBeforeCollapse : function (node) {},
        onCollapse : function (node) {}, onBeforeCheck : function (node, _1d1) {},
        onCheck : function (node, _1d2) {}, onBeforeSelect : function (node) {},
        onSelect : function (node) {}, onContextMenu : function (e, node) {}, onBeforeDrag : function (node) {},
        onStartDrag : function (node) {}, onStopDrag : function (node) {}, onDragEnter : function (_1d3,
                                                                                                   _1d4) {}, onDragOver : function (_1d5, _1d6) {}, onDragLeave : function (_1d7, _1d8) {},
        onBeforeDrop : function (_1d9, _1da, _1db) {}, onDrop : function (_1dc, _1dd, _1de) {},
        onBeforeEdit : function (node) {}, onAfterEdit : function (node) {}, onCancelEdit : function (node) {}
    };
})(jQuery);
(function ($)
{
        ...
        return this.each(function ()
        {
            ...
            else
            {
                _1e7 = $.data(this, "progressbar",
                    {
                        options : $.extend({}, $.fn.progressbar.defaults, $.fn.progressbar.parseOptions(this),
                            _1e4), bar : init(this)
                    });
            }
...
(function ($)
{
    ...
    function _1f4(_1f5)
    {
        ...
        tip.css(
            {
                left : pos.left, top : pos.top, zIndex : (opts.zIndex != undefined ? opts.zIndex : ($.fn.window ? $.fn.window.defaults.zIndex++: ""))
            });
    ...
    $.fn.tooltip.defaults =
    {
        position : "bottom", content : null, trackMouse : false, deltaX : 0, deltaY : 0, showEvent : "mouseenter",
        hideEvent : "mouseleave", showDelay : 200, hideDelay : 100, onShow : function (e) {},
        onHide : function (e) {}, onUpdate : function (_20f) {}, onPosition : function (left, top) {},
        onDestroy : function () {}
    };
})(jQuery);
(function ($)
{
    ...
    function _211(_212, _213)
    {
        ...
        if (_213)
        {
            $.extend(opts,
                {
                    width : _213.width, height : _213.height, minWidth : _213.minWidth, maxWidth : _213.maxWidth,
                    minHeight : _213.minHeight, maxHeight : _213.maxHeight, left : _213.left, top : _213.top
                });
        }
        _215._size(opts);
        ...
        _215.css({
            height : "", minHeight : "", maxHeight : "", left : opts.left, top : opts.top
        });
        ...
        return this.each(function ()
        {
            ...
            else
            {
                ...
                _25f = $.data(this, "panel", {
                    options : opts, panel : _21f(this), isLoaded : false
                });
            }
            _223(this);
            $(this).show();
        ...
        doLayout : function (jq, all)
        {
            return jq.each(function ()
            {
                ...
                function _266(_267, type)
                {
                    ...
                    var s = $(_267).find("div.panel:visible,div.accordion:visible,div.tabs-container:visible,div.layout:visible,.easyui-fluid:visible").filter(function (_269,
                                                                                                                                                                         el) {
    ...
    $.fn.panel.parseOptions = function (_26d)
    {
        ...
        return $.extend({}, $.parser.parseOptions(_26d, ["id", "width", "height", "left", "top", "title",
                ...
                {
                    closable : "boolean", collapsed : "boolean", minimized : "boolean", maximized : "boolean",
                    closed : "boolean"
                },
            ...
            ]),
            {
                ...
                header : (hh.length ? hh.removeClass("panel-header") : undefined), footer : (ff.length ? ff.removeClass("panel-footer") : undefined)
            });
    };
    $.fn.panel.defaults =
    {
        id : null, title : null, iconCls : null, width : "auto", height : "auto", left : null, top : null,
        cls : null, headerCls : null, bodyCls : null, style : {}, href : null, cache : true, fit : false,
        border : true, doSize : true, noheader : false, content : null, collapsible : false, minimizable : false,
        maximizable : false, closable : false, collapsed : false, minimized : false, maximized : false,
        closed : false, openAnimation : false, openDuration : 400, closeAnimation : false, closeDuration : 400,
        tools : null, footer : null, header : null, queryParams : {}, method : "get", href : null, loadingMessage : "Loading...",
        loader : function (_26e, _26f, _270)
        {
            ...
            $.ajax(
                {
                    type : opts.method, url : opts.href, cache : false, data : _26e, dataType : "html",
                    success : function (data)
                    {
                        _26f(data);
                    },
        ...
        onBeforeLoad : function (_273) {}, onLoad : function () {}, onLoadError : function () {},
        onBeforeOpen : function () {}, onOpen : function () {}, onBeforeClose : function () {},
        onClose : function () {}, onBeforeDestroy : function () {}, onDestroy : function () {},
        onResize : function (_274, _275) {}, onMove : function (left, top) {}, onMaximize : function () {},
        onRestore : function () {}, onMinimize : function () {}, onBeforeCollapse : function () {},
        onBeforeExpand : function () {}, onCollapse : function () {}, onExpand : function () {}
    };
})(jQuery);
(function ($)
{
    function _276(_277, _278)
    {
        ...
        if (_279.shadow) {
            _279.shadow.css({
                left : _279.options.left, top : _279.options.top
            });
        }
    };
    ...
    function _284(_285)
    {
        ...
        var win = $(_285).panel($.extend({}, _286.options,
            {
                border : false, doSize : true, closed : true, cls : "window " + (!opts.border ? "window-thinborder window-noborder " : (opts.border == "thin" ? "window-thinborder " : "")) + (opts.cls || ""),
                headerCls : "window-header " + (opts.headerCls || ""), bodyCls : "window-body " + (opts.noheader ? "window-body-noheader " : " ") + (opts.bodyCls || ""),
                ...
                onOpen : function ()
                {
                    ...
                    if (_286.shadow)
                    {
                        _286.shadow.css(
                            {
                                display : "block", zIndex : $.fn.window.defaults.zIndex++, left : opts.left, top : opts.top,
                                width : _286.window._outerWidth(), height : _286.window._outerHeight()
                            });
                    }
                ...
                onResize : function (_287, _288)
                {
                    ...
                    $.extend(opts, {
                        width : _289.width, height : _289.height, left : _289.left, top : _289.top
                    });
                    if (_286.shadow)
                    {
                        _286.shadow.css(
                            {
                                left : opts.left, top : opts.top, width : _286.window._outerWidth(), height : _286.window._outerHeight()
                            });
                    }
    ...
    function _28b(left, top, _28c, _28d)
    {
        ...
        return {
            left : left, top : top, width : _28c, height : _28d
        };
    };
    function _291(_292)
    {
        ...
        _293.window.draggable(
            {
                handle : ">div.panel-header>div.panel-title", disabled : _293.options.draggable == false,
                onBeforeDrag : function (e)
                {
                    if (_293.mask) {
            ...
            _293.pmask.css(
                {
                    ...
                    width : _293.window._outerWidth(), height : _293.window._outerHeight()
                });
            if (_293.proxy) {
                _293.proxy.remove();
            }
    ...
    $.fn.window.methods =
    {
        options : function (jq)
        {
            ...
            return $.extend(_29c, {
                closed : _29b.closed, collapsed : _29b.collapsed, minimized : _29b.minimized, maximized : _29b.maximized
            });
        },
        window : function (jq)
        {
    ...
    $.fn.window.defaults = $.extend({}, $.fn.panel.defaults,
        {
            zIndex : 9000, draggable : true, resizable : true, shadow : true, modal : false, border : true,
            inline : false, title : "New Window", collapsible : true, minimizable : true, maximizable : true,
            closable : true, closed : false, constrain : false
        });
})(jQuery);
(function ($)
{
    ...
    function _2a7(_2a8, _2a9)
    {
        ...
        tb.insertBefore(_2a8).css({
            borderTopWidth : (_2aa ? 1 : 0), top : (_2aa ? tb.length : 0)
        });
        bb.insertAfter(_2a8);
        ...
        if (_2ae)
        {
            ...
            _2ae.css({
                width : cc._outerWidth(), height : cc._outerHeight()
            });
        }
    };
    ...
    $.fn.dialog.methods =
    {
        options : function (jq)
        {
            ...
            $.extend(_2b3,
                {
                    width : _2b4.width, height : _2b4.height, left : _2b4.left, top : _2b4.top, closed : _2b4.closed,
                    collapsed : _2b4.collapsed, minimized : _2b4.minimized, maximized : _2b4.maximized
                });
            return _2b3;
        },
        dialog : function (jq)
    ...
    $.fn.dialog.defaults = $.extend({}, $.fn.window.defaults,
        {
            title : "New Dialog", collapsible : false, minimizable : false, maximizable : false, resizable : false,
            toolbar : null, buttons : null
        });
})(jQuery);
(function ($)
{
    ...
    function _2bb(_2bc)
    {
        var opts = $.extend({}, $.messager.defaults,
            {
                async : true, modal : true, shadow : false, draggable : false, resizable : false, closed : true,
                style :
                {
                    left : "", top : "", right : 0, zIndex : $.fn.window.defaults.zIndex++, bottom :- document.body.scrollTop - document.documentElement.scrollTop
                },
                title : "", width : 250, height : 100, minHeight : 0, showType : "slide", showSpeed : 600,
                content : _2bc.msg, timeout : 4000
            }, _2bc);
        var dlg = $("<div class=\"messager-body\"></div>").appendTo("body");
        dlg.dialog($.extend({}, opts,
            {
                noheader : (opts.title ? false : true), openAnimation : (opts.showType), closeAnimation : (opts.showType == "show" ? "hide" : opts.showType),
                openDuration : opts.showSpeed, closeDuration : opts.showSpeed,
                onOpen : function ()
                {
    ...
    $.messager =
    {
        ...
        alert : function (_2c2, msg, icon, fn)
        {
            var opts = typeof _2c2 == "object" ? _2c2 : {
                title : _2c2, msg : msg, icon : icon, fn : fn
            };
    ...
    $.messager.defaults = $.extend({}, $.fn.dialog.defaults,
        {
            ok : "Ok", cancel : "Cancel", width : 300, height : "auto", minHeight : 150, modal : true, collapsible : false,
            minimizable : false, maximizable : false, resizable : false, fn : function () {}
        });
})(jQuery);
(function ($)
{
    function _2c8(_2c9, _2ca)
    {
        ...
        if (_2ca) {
            $.extend(opts, {
                width : _2ca.width, height : _2ca.height
            });
        }
        cc._size(opts);
        var _2cd = 0;
        ...
        function _2d0(_2d1, _2d2)
        {
            ...
            for (var i = 0; i < _2cc.length; i++)
            {
                ...
                if (p.panel("options").collapsible == _2d1)
                {
                    ...
                    p.panel("resize", {
                        width : cc.width(), height : (_2d1 ? _2d4 : undefined)
                    });
    ...
    function _2ea(_2eb, pp, _2ec)
    {
        ...
        pp.panel($.extend({},
            {
                collapsible : true, minimizable : false, maximizable : false, closable : false, doSize : false,
                collapsed : true, headerCls : "accordion-header", bodyCls : "accordion-body"
            },
            _2ec,
            {
    ...
    $.fn.accordion = function (_30d, _30e)
    {
        ...
        return this.each(function ()
        {
            ...
            else
            {
                $.data(this, "accordion",
                    {
                        options : $.extend({}, $.fn.accordion.defaults, $.fn.accordion.parseOptions(this),
                            _30d), accordion : $(this).addClass("accordion"), panels : []
                    });
                init(this);
            }
            _2e5(this);
    ...
    {
        width : "auto", height : "auto", fit : false, border : true, animate : true, multiple : false,
        selected : 0, onSelect : function (_318, _319) {}, onUnselect : function (_31a, _31b) {},
        onAdd : function (_31c, _31d) {}, onBeforeRemove : function (_31e, _31f) {},
...
(function ($)
{
    ...
    function _323(_324)
    {
        ...
        if (_329 > _32a)
        {
            ...
            {
                tool.css({
                    left : _326.outerWidth(), right : ""
                });
                wrap.css(
                    {
                        marginLeft : _326.outerWidth() + tool._outerWidth(), marginRight : _327._outerWidth(),
            ...
            {
                tool.css({
                    left : "", right : _327.outerWidth()
                });
                wrap.css(
                    {
                        marginLeft : _326.outerWidth(), marginRight : _327.outerWidth() + tool._outerWidth(),
                        width : _32a - _326.outerWidth() - _327.outerWidth()
                    });
            }
        }
        else
        {
            ...
            if (opts.toolPosition == "left")
            {
                ...
                wrap.css({
                    marginLeft : tool._outerWidth(), marginRight : 0, width : _32a
                });
            }
            else
            {
                ...
                wrap.css({
                    marginLeft : 0, marginRight : tool._outerWidth(), width : _32a
                });
            }
        }
    };
    ...
    function _32f(_330, _331)
    {
        ...
        if (_331) {
            $.extend(opts, {
                width : _331.width, height : _331.height
            });
        }
        cc._size(opts);
        ...
        {
            _333.children("div.tabs-scroller-left,div.tabs-scroller-right,div.tabs-tool:not(.tabs-tool-hidden)").css("display",
    ...
    function _341(_342)
    {
        ...
        cc.children("div.tabs-panels").children("div").each(function (i)
        {
            var opts = $.extend({}, $.parser.parseOptions(this),
                {
                    disabled : ($(this).attr("disabled") ? true : undefined), selected : ($(this).attr("selected") ? true : undefined)
                });
            _350(_342, opts, $(this));
        });
    ...
    function _350(_351, _352, pp)
    {
        ...
        pp.panel($.extend({}, _352,
            {
                tab : tab, border : false, noheader : true, closed : true, doSize : false, iconCls : (_352.icon ? _352.icon : undefined),
                onLoad : function ()
                {
                    if (_352.onLoad) {
    ...
    $.fn.tabs = function (_389, _38a)
    {
        ...
        return this.each(function ()
        {
            ...
            else
            {
                $.data(this, "tabs",
                    {
                        options : $.extend({}, $.fn.tabs.defaults, $.fn.tabs.parseOptions(this), _389), tabs : [],
                        selectHis : []
                    });
                _341(this);
            }
    ...
    $.fn.tabs.defaults =
    {
        width : "auto", height : "auto", headerWidth : 150, tabWidth : "auto", tabHeight : 27, selected : 0,
        showHeader : true, plain : false, fit : false, border : true, justified : false, narrow : false,
        pill : false, tools : null, toolPosition : "right", tabPosition : "top", scrollIncrement : 100,
        scrollDuration : 400, onLoad : function (_399) {}, onSelect : function (_39a, _39b) {},
        onUnselect : function (_39c, _39d) {}, onBeforeClose : function (_39e, _39f) {},
        onClose : function (_3a0, _3a1) {}, onAdd : function (_3a2, _3a3) {}, onUpdate : function (_3a4,
                                                                                                   _3a5) {}, onContextMenu : function (e, _3a6, _3a7) {}
    };
})(jQuery);
(function ($)
{
    ...
    function _3a9(_3aa, _3ab)
    {
        ...
        if (_3ab) {
            $.extend(opts, {
                width : _3ab.width, height : _3ab.height
            });
        }
        ...
        function _3ae(pp, type)
        {
            ...
            pp.panel("move", {
                left : 0, top : (type == "n" ? 0 : cc.height() - _3b1)
            });
            cpos.height -= _3b1;
            if (type == "n") {
                cpos.top += _3b1;
        ...
        function _3b0(pp, type)
        {
            ...
            pp.panel("move", {
                left : (type == "e" ? cc.width() - _3b2 : 0), top : cpos.top
            });
            cpos.width -= _3b2;
            if (type == "w") {
                cpos.left += _3b2;
    ...
    function _3b8(_3b9, _3ba, el)
    {
        ...
        var _3bc = $.extend({}, $.fn.layout.paneldefaults,
            {
                width : (pp.length ? parseInt(pp[0].style.width) || pp.outerWidth() : "auto"), height : (pp.length ? parseInt(pp[0].style.height) || pp.outerHeight() : "auto"),
                doSize : false, collapsible : true,
                onOpen : function ()
                {
            ...
            _3ba,
            {
                cls : ((_3ba.cls || "") + " layout-panel layout-panel-" + dir), bodyCls : ((_3ba.bodyCls || "") + " layout-body")
            });
        pp.panel(_3bc);
        _3bb[dir] = pp;
        var _3bf = {
        ...
        _3c0.resizable($.extend({},
            {
                handles : (_3bf[dir] || ""), disabled : (!pp.panel("options").split),
                onStartResize : function (e)
                {
                    _3a8 = true;
    ...
    function _3ca(_3cb, _3cc, _3cd)
    {
        ...
        {
            var _3d5 = {
                "east" : "left", "west" : "right", "north" : "down", "south" : "up"
            };
            ...
            p.panel($.extend({}, $.fn.layout.paneldefaults,
                {
                    cls : ("layout-expand layout-expand-" + dir), title : "&nbsp;", iconCls : (_3cf.hideCollapsedContent ? null : _3cf.iconCls),
                    closed : true, minWidth : 0, minHeight : 0, doSize : false, region : _3cf.region, collapsedSize : _3cf.collapsedSize,
                    noheader : (!isns && _3cf.hideExpandTool), tools : ((isns && _3cf.hideExpandTool) ? null : [ {
                    iconCls : icon,
                    handler : function ()
                    {
                        _3dc(_3cb, _3cc);
            ...
            {
                var _3d6 = typeof _3cf.collapsedContent == "function" ? _3cf.collapsedContent.call(p[0],
                    _3cf.title) : _3cf.collapsedContent;
        ...
        function _3d3()
        {
            ...
            if (_3cc == "east")
            {
                ...
                return {
                    ...
                    expandP : {
                        top : _3d7.top, left : cc.width() - _3d8, width : _3d8, height : _3d7.height
                    },
                    collapse : {
                        left : cc.width(), top : _3d7.top, height : _3d7.height
                    }
                };
            }
            else
            {
                if (_3cc == "west")
                {
                    ...
                    return {
                        resizeC : {
                            width : _3da, left : _3d8 - 1
                        },
                        expand : {
                            left : 0
                        },
                        expandP : {
                            left : 0, top : _3d7.top, width : _3d8, height : _3d7.height
                        },
                        collapse : {
                            left :- _3d9, top : _3d7.top, height : _3d7.height
                        }
                    };
                }
                else
                {
                    if (_3cc == "north")
                    {
                        ...
                        return {
                            ...
                            expandP : {
                                top : 0, left : 0, width : cc.width(), height : _3d8
                            },
                            collapse : {
                                top :- _3db, width : cc.width()
                            }
                        };
                    }
                    else
                    {
                        if (_3cc == "south")
                        {
                            ...
                            return {
                                ...
                                expandP : {
                                    top : cc.height() - _3d8, left : 0, width : cc.width(), height : _3d8
                                },
                                collapse : {
                                    top : cc.height(), width : cc.width()
                                }
                            };
                        }
                    }
    ...
    function _3dc(_3dd, _3de)
    {
        ...
        function _3e3()
        {
            ...
            if (_3de == "east" && _3df.expandEast)
            {
                return {
                    collapse : {
                        left : cc.width(), top : _3e4.top, height : _3e4.height
                    },
                    expand : {
            ...
            else
            {
                if (_3de == "west" && _3df.expandWest)
                {
                    return {
                        collapse : {
                            left :- p.panel("panel")._outerWidth(), top : _3e4.top, height : _3e4.height
                        },
                        expand : {
                            left : 0
                        }
                ...
                else
                {
                    if (_3de == "north" && _3df.expandNorth)
                    {
                        return {
                            collapse : {
                                top :- p.panel("panel")._outerHeight(), width : cc.width()
                            },
                            expand : {
                                top : 0
                            }
    ...
    $.fn.layout.defaults =
    {
        fit : false, onExpand : function (_3fd) {}, onCollapse : function (_3fe) {},
        onAdd : function (_3ff) {}, onRemove : function (_400) {}
    };
    $.fn.layout.parsePanelOptions = function (_401)
    {
        var t = $(_401);
        return $.extend({}, $.fn.panel.parseOptions(_401), $.parser.parseOptions(_401, ["region", {
            split : "boolean", collpasedSize : "number", minWidth : "number", minHeight : "number", maxWidth : "number",
            maxHeight : "number"
        }]));
    };
    $.fn.layout.paneldefaults = $.extend({}, $.fn.panel.defaults,
        {
            region : null, split : false, collapsedSize : 28, expandMode : "float", hideExpandTool : false,
...
(function ($)
{
    ...
    function _40d(_413, menu)
    {
        ...
        menu.css({
            display : "block", left :- 10000, height : "auto", overflow : "hidden"
        });
        menu.find(".menu-item").each(function ()
        {
            $(this)._outerHeight(opts.itemHeight);
            $(this).find(".menu-text").css({
                height : (opts.itemHeight - 2) + "px", lineHeight : (opts.itemHeight - 2) + "px"
            });
        });
        ...
        menu._size($.extend({}, _416,
            {
                width : _417, height : _418, minWidth : _416.minWidth || opts.minWidth, maxWidth : _416.maxWidth || opts.maxWidth
            }));
    ...
    function _42f(_430, _431)
    {
        ...
        menu.show(0, function ()
        {
            ...
            menu[0].shadow.css(
                {
                    display : (menu.hasClass("menu-inline") ? "none" : "block"), zIndex : $.fn.menu.defaults.zIndex++,
                    left : menu.css("left"), top : menu.css("top"), width : menu.outerWidth(), height : menu.outerHeight()
                });
    ...
    $.fn.menu = function (_44b, _44c)
    {
        ...
        return this.each(function ()
        {
            ...
            $(this).css({
                left : _44d.options.left, top : _44d.options.top
            });
        });
    };
    $.fn.menu.methods =
    ...
    $.fn.menu.defaults =
    {
        zIndex : 110000, left : 0, top : 0, alignTo : null, align : "left", minWidth : 120, itemHeight : 22,
        duration : 100, hideOnUnhover : true, inline : false, fit : false, noline : false, events : {
        mouseenter : _41d, mouseleave : _420, mouseover : _424, mouseout : _427, click : _429
    },
        ...
        return this.each(function ()
        {
            ...
            else
            {
                $.data(this, "menubutton",
                    {
                        options : $.extend({}, $.fn.menubutton.defaults, $.fn.menubutton.parseOptions(this),
                            _467)
                    });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.menubutton.methods =
    {
        options : function (jq)
        {
            ...
            return $.extend($.data(jq[0], "menubutton").options, {
                toggle : _46b.toggle, selected : _46b.selected, disabled : _46b.disabled
            });
        },
        destroy : function (jq)
        {
...
(function ($)
{
        ...
        return this.each(function ()
        {
            ...
            else
            {
                $.data(this, "splitbutton",
                    {
                        options : $.extend({}, $.fn.splitbutton.defaults, $.fn.splitbutton.parseOptions(this),
                            _46e)
                    });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.splitbutton.methods =
    {
        options : function (jq)
        {
            ...
            $.extend(_473, {
                disabled : _472.disabled, toggle : _472.toggle, selected : _472.selected
            });
            return _473;
        }
    };
    ...
    $.fn.splitbutton.defaults = $.extend({}, $.fn.linkbutton.defaults,
        ...
        {
            btn1 : "m-btn-active s-btn-active", btn2 : "m-btn-plain-active s-btn-plain-active", arrow : "m-btn-downarrow",
            trigger : "m-btn-line"
        }
        });
})(jQuery);
(function ($)
{
        ...
        return this.each(function ()
        {
            ...
            else
            {
                _49d = $.data(this, "switchbutton",
                    {
                        options : $.extend({}, $.fn.switchbutton.defaults, $.fn.switchbutton.parseOptions(this),
                            _49b), switchbutton : init(this)
                    });
            }
    ...
    $.fn.switchbutton.parseOptions = function (_4a1)
    {
        ...
        return $.extend({}, $.parser.parseOptions(_4a1, ["onText", "offText", "handleText", {
            ...
            {
                value : (t.val() || undefined), checked : (t.attr("checked") ? true : undefined), disabled : (t.attr("disabled") ? true : undefined),
                readonly : (t.attr("readonly") ? true : undefined)
            });
    };
    $.fn.switchbutton.defaults =
    {
        handleWidth : "auto", width : 60, height : 26, checked : false, disabled : false, readonly : false,
        reversed : false, onText : "ON", offText : "OFF", handleText : "", value : "on", onChange : function (_4a2) {}
    };
})(jQuery);
(function ($)
{
        ...
        else
        {
            if ((t.is(":focus") && _4bb.validating) || _4ba == "show")
            {
                t.tooltip($.extend({}, opts.tipOptions, {
                    content : _4b9, position : opts.tipPosition, deltaX : opts.deltaX
                })).tooltip("show");
            }
        }
    };
        ...
        return this.each(function ()
        {
            ...
            else
            {
                ...
                _4d2 = $.data(this, "validatebox",
                    {
                        options : $.extend({}, $.fn.validatebox.defaults, $.fn.validatebox.parseOptions(this),
                            _4d0)
                    });
            }
    ...
    {
        var t = $(_4d3);
        return $.extend({}, $.parser.parseOptions(_4d3, ["validType", "missingMessage", "invalidMessage",
                "tipPosition", {
            ...
            {
                required : (t.attr("required") ? true : undefined), disabled : (t.attr("disabled") ? true : undefined),
                readonly : (t.attr("readonly") ? true : undefined), novalidate : (t.attr("novalidate") != undefined ? true : undefined)
            });
    };
    $.fn.validatebox.defaults =
    {
        required : false, validType : null, validParams : null, delay : 200, interval : 200, missingMessage : "This field is required.",
        invalidMessage : null, tipPosition : "right", deltaX : 0, novalidate : false, editable : true,
        disabled : false, readonly : false, validateOnCreate : true, validateOnBlur : false, events :
    {
        focus : _4aa, blur : _4ae, mouseenter : _4b1, mouseleave : _4b4,
        click : function (e)
        {
            var t = $(e.data.target);
        ...
        rules :
        {
            ...
            remote :
            {
                validator : function (_4dc, _4dd)
                {
                    ...
                    data[_4dd[1]] = _4dc;
                    var _4de = $.ajax({
                        url : _4dd[0], dataType : "json", data : data, async : false, cache : false, type : "post"
                    }).responseText;
                    return _4de == "true";
                },
        ...
        onBeforeValidate : function () {}, onValidate : function (_4df) {}
    };
})(jQuery);
(function ($)
{
    ...
    function _4e2(_4e3)
    {
        ...
        if (opts.iconCls) {
            bb.push({
                iconCls : opts.iconCls, disabled : true
            });
        }
        if (bb.length)
        {
    ...
    function _4eb(_4ec, _4ed)
    {
        ...
        if (opts.height == "auto") {
            _4f1.css({
                margin : "", paddingTop : "", paddingBottom : "", height : "", lineHeight : ""
            });
        }
        tb._size(opts, _4ef);
        ...
        _4f3.css({
            width : opts.iconWidth + "px", height : _4f6 + "px"
        });
        _4f1.css(
            {
                paddingLeft : (_4ec.style.paddingLeft || ""), paddingRight : (_4ec.style.paddingRight || ""),
                marginLeft : _4f7("left"), marginRight : _4f7("right"), marginTop : _4f5("top"), marginBottom : _4f5("bottom")
            });
        if (opts.multiline)
        {
            _4f1.css(
                {
                    paddingTop : (_4ec.style.paddingTop || ""), paddingBottom : (_4ec.style.paddingBottom || "")
                });
            _4f1._outerHeight(_4f6);
        }
        else {
            _4f1.css({
                paddingTop : 0, paddingBottom : 0, height : _4f6 + "px", lineHeight : _4f6 + "px"
            });
        }
    ...
    $.fn.textbox.methods =
    {
        ...
        cloneFrom : function (jq, from)
        {
            return jq.each(function ()
            {
                ...
                $.data(this, "textbox", {
                    options : opts, textbox : span, label : (_515.length ? _515 : undefined)
                });
    ...
    {
        var t = $(_52c);
        return $.extend({}, $.fn.validatebox.parseOptions(_52c), $.parser.parseOptions(_52c, ["prompt",
            "iconCls", "iconAlign", "buttonText", "buttonIcon", "buttonAlign", "label", "labelPosition", "labelAlign",
            {
    ...
    $.fn.textbox.defaults = $.extend({}, $.fn.validatebox.defaults,
        {
            doSize : true, width : "auto", height : "auto", prompt : "", value : "", type : "text", multiline : false,
            icons : [], iconCls : null, iconAlign : "right", iconWidth : 18, buttonText : "", buttonIcon : null,
            buttonAlign : "right", label : null, labelWidth : "auto", labelPosition : "before", labelAlign : "left",
            inputEvents :
            {
                blur : function (e)
                {
            ...
            onChange : function (_52d, _52e) {}, onResize : function (_52f, _530) {},
            onClickButton : function () {}, onClickIcon : function (_531) {}
        });
})(jQuery);
(function ($)
{
        ...
        return this.each(function ()
        {
            ...
            else
            {
                _548 = $.data(this, "passwordbox",
                    {
                        options : $.extend({}, $.fn.passwordbox.defaults, $.fn.passwordbox.parseOptions(this),
                            _545)
                    });
            }
            _532(this);
    ...
    $.fn.passwordbox.defaults = $.extend({}, $.fn.textbox.defaults,
        {
            passwordChar : "%u25CF", checkInterval : 200, lastDelay : 500, revealed : false, showEye : true,
            inputEvents : {
                focus : _53e, blur : _542
            },
            val : function (_54b)
            {
    ...
    $.fn.filebox.methods =
    {
        options : function (jq)
        {
            ...
            return $.extend($.data(jq[0], "filebox").options, {
                width : opts.width, value : opts.value, originalValue : opts.originalValue, disabled : opts.disabled,
    ...
    $.fn.filebox.defaults = $.extend({}, $.fn.textbox.defaults,
        {
            ...
            accept : "", separator : ",", multiple : false
        });
})(jQuery);
(function ($)
{
    function _559(_55a)
    {
        ...
        $(_55a).addClass("searchbox-f").textbox($.extend({}, opts, {
            icons : _55c, buttonText : (_55e ? _55e.text : "")
        }));
        ...
        function _560(item)
        {
            ...
            $(_55a).textbox("button").menubutton(
                {
                    text : item.text, iconCls : (item.iconCls || null), menu : _55b.menu, menuAlign : opts.buttonAlign,
                    plain : false
                });
    ...
    $.fn.searchbox = function (_564, _565)
    {
        ...
        return this.each(function ()
        {
            ...
            else
            {
                $.data(this, "searchbox",
                    {
                        options : $.extend({}, $.fn.searchbox.defaults, $.fn.searchbox.parseOptions(this),
                            _564)
                    });
            }
            _559(this);
...
(function ($)
{
        ...
        $.ajax(
            {
                ...
                data : _57e, dataType : "html", cache : false, contentType : false, processData : false,
    ...
    function load(_582, data)
    {
        ...
        if (typeof data == "string")
        {
            ...
            $.ajax(
                {
                    url : data, data : _583, dataType : "json",
                    success : function (data)
                    {
                        _584(data);
                    },
    ...
    $.fn.form.defaults =
    {
        fieldTypes : ["combobox", "combotree", "combogrid", "combotreegrid", "datetimebox", "datebox",
            "combo", "datetimespinner", "timespinner", "numberspinner", "spinner", "slider", "searchbox",
            "numberbox", "passwordbox", "filebox", "textbox", "switchbutton"], novalidate : false, ajax : true,
        iframe : true, dirty : false, dirtyFields : [], url : null, queryParams : {},
        onSubmit : function (_5a2)
        {
            return $(this).form("validate");
        },
        onProgress : function (_5a3) {}, success : function (data) {}, onBeforeLoad : function (_5a4) {},
        onLoadSuccess : function (data) {}, onLoadError : function () {}, onChange : function (_5a5) {}
    };
})(jQuery);
(function ($)
{
        ...
        return this.each(function ()
        {
            ...
            else
            {
                _5b2 = $.data(this, "numberbox",
                    {
                        options : $.extend({}, $.fn.numberbox.defaults, $.fn.numberbox.parseOptions(this),
                            _5af)
                    });
            }
            _5a6(this);
    ...
    {
        var t = $(_5b4);
        return $.extend({}, $.fn.textbox.parseOptions(_5b4), $.parser.parseOptions(_5b4, ["decimalSeparator",
    ...
    $.fn.numberbox.defaults = $.extend({}, $.fn.textbox.defaults,
        {
            ...
            min : null, max : null, precision : 0, decimalSeparator : ".", groupSeparator : "", prefix : "",
            suffix : "",
            filter : function (e)
            {
...
(function ($)
{
    function _5b9(_5ba, _5bb)
    {
        ...
        if (_5bb) {
            $.extend(opts, {
                width : _5bb.width, height : _5bb.height
            });
        }
    ...
    {
        width : 180, height : 180, fit : false, border : true, showWeek : false, firstDay : 0, weeks : ["S",
        "M", "T", "W", "T", "F", "S"], months : ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug",
        "Sep", "Oct", "Nov", "Dec"], year : new Date().getFullYear(), month : new Date().getMonth() + 1,
        current : (function ()
        {
            var d = new Date();
        ...
        onSelect : function (date) {}, onChange : function (_5ea, _5eb) {}, onNavigate : function (year,
                                                                                                   _5ec) {}
    };
})(jQuery);
(function ($)
{
    ...
    {
        return $.extend({}, $.fn.textbox.parseOptions(_601), $.parser.parseOptions(_601, ["min", "max",
            "spinAlign", {
    ...
    $.fn.spinner.defaults = $.extend({}, $.fn.textbox.defaults,
        {
            ...
            onSpinUp : function () {}, onSpinDown : function () {}
        });
})(jQuery);
(function ($)
{
        ...
        return this.each(function ()
        {
            ...
            else
            {
                $.data(this, "numberspinner",
                    {
                        options : $.extend({}, $.fn.numberspinner.defaults, $.fn.numberspinner.parseOptions(this),
                            _606)
                    });
            }
            _602(this);
        ...
        return this.each(function ()
        {
            ...
            else
            {
                $.data(this, "timespinner",
                    {
                        options : $.extend({}, $.fn.timespinner.defaults, $.fn.timespinner.parseOptions(this),
                            _61c)
                    });
            }
            _60b(this);
    ...
    $.fn.timespinner.defaults = $.extend({}, $.fn.spinner.defaults,
        {
            ...
            parser : function (s)
            {
                ...
                function _624(s)
                {
                    ...
                    return new Date(1900, 0, 0, parseInt(tt[0], 10) || 0, parseInt(tt[1], 10) || 0, parseInt(tt[2],
                            10) || 0);
                };
            },
            selections : [[0, 2], [3, 5], [6, 8]], separator : ":", showSeconds : false, highlight : 0,
            spin : function (down)
            {
                _619(this, down);
            }
        ...
        return this.each(function ()
        {
            ...
            else
            {
                $.data(this, "datetimespinner",
                    {
                        options : $.extend({}, $.fn.datetimespinner.defaults, $.fn.datetimespinner.parseOptions(this),
                            _627)
                    });
            }
            _625(this);
    ...
    $.fn.datetimespinner.defaults = $.extend({}, $.fn.timespinner.defaults,
        {
            ...
            parser : function (s)
            {
                ...
                return new Date(_62c.getFullYear(), _62c.getMonth(), _62c.getDate(), _62d.getHours(), _62d.getMinutes(),
                    _62d.getSeconds());
            },
...
(function ($)
{
    ...
    function _648(_649)
    {
        ...
        _64d.add(_64e).children("div.datagrid-body").css(
            {
                marginTop : _654, height : (isNaN(parseInt(opts.height)) ? "" : (_64c - _655)), minHeight : (_657 ? _657 - _656 - _655 : ""),
    ...
    function _66d(_66e, _66f)
    {
        function _670()
        {
            ...
            $(_66e).children("thead").each(function ()
            {
                ...
                $(this).find("tr").each(function ()
                {
                    ...
                    {
                        var th = $(this);
                        var col = $.extend({}, $.parser.parseOptions(this, ["id", "field", "align", "halign",
                                "order", "width", {
                                ...
                                }]),
                            {
                                ...
                                styler : (th.attr("styler") ? eval(th.attr("styler")) : undefined), sorter : (th.attr("sorter") ? eval(th.attr("sorter")) : undefined)
                            });
        ...
        return {
            panel : _673, frozenColumns : cc[0], columns : cc[1], dc :
            {
                view : view, view1 : _674, view2 : _675, header1 : _674.children("div.datagrid-header").children("div.datagrid-header-inner"),
                header2 : _675.children("div.datagrid-header").children("div.datagrid-header-inner"),
                body1 : _674.children("div.datagrid-body").children("div.datagrid-body-inner"), body2 : _675.children("div.datagrid-body"),
    ...
    function _676(_677)
    {
        ...
        if (opts.pagination)
        {
            ...
            _67e.pagination(
                {
                    total : (opts.pageNumber * opts.pageSize), pageNumber : opts.pageNumber, pageSize : opts.pageSize,
        ...
        function _67d()
        {
            var _689 = [[".datagrid-header-rownumber", (opts.rownumberWidth - 1) + "px"], [".datagrid-cell-rownumber",
    ...
    function _68d(_68e)
    {
        ...
        _693.each(function ()
        {
            $(this).resizable(
                {
                    handles : _694, disabled : ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false),
                    minWidth : 25,
                    onStartResize : function (e)
                    {
                        _68f.resizing = true;
                        ...
                        _68f.proxy.css({
                            left : e.pageX - $(_690).offset().left - 1, display : "none"
                        });
                        setTimeout(function ()
                        {
                            if (_68f.proxy) {
                    ...
                    {
                        _68f.proxy.css({
                            left : e.pageX - $(_690).offset().left - 1, display : "block"
                        });
                        return false;
                    },
                    onStopResize : function (e)
            ...
            if (col && col.editor)
            {
                ...
                if (_774)
                {
                    ...
                    $.data(cell[0], "datagrid.editor",
                        {
                            actions : _774, target : _774.init(cell.find("td"), $.extend({
                            height : opts.editorHeight
                        }, _773)), field : _771, type : _772, oldHtml : _775
                        });
                }
            }
        });
    ...
    $.fn.datagrid = function (_7b2, _7b3)
    {
        ...
        return this.each(function ()
        {
            ...
            else
            {
                ...
                $.data(this, "datagrid",
                    {
                        options : opts, panel : _7b5.panel, dc : _7b5.dc, ss : null, selectedRows : [], checkedRows : [],
                        data : {
                            total : 0, rows : []
                        },
            ...
            return {
                ...
                resize : function (_7c2, _7c3)
                {
                    if (isA(_7c2, name)) {
                        ...
                        $(_7c2)._size({
                            width : _7c3, height : $.fn.datagrid.defaults.editorHeight
                        });
                    }
                }
            };
    ...
    var _7c4 = $.extend({}, _7b6(["text", "textbox", "passwordbox", "filebox", "numberbox", "numberspinner",
            "combobox", "combotree", "combogrid", "combotreegrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]),
    ...
    $.fn.datagrid.methods =
    {
        options : function (jq)
        {
            ...
            var opts = $.extend(_7dd,
                {
                    width : _7de.width, height : _7de.height, closed : _7de.closed, collapsed : _7de.collapsed,
                    minimized : _7de.minimized, maximized : _7de.maximized
                });
            return opts;
        },
    ...
    {
        var t = $(_80a);
        return $.extend({}, $.fn.panel.parseOptions(_80a), $.parser.parseOptions(_80a, ["url", "toolbar",
                "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle",
                {
                    sharedStyleSheet : "boolean", fitColumns : "boolean", autoRowHeight : "boolean", striped : "boolean",
                    nowrap : "boolean"
                },

                {
                    rownumbers : "boolean", singleSelect : "boolean", ctrlSelect : "boolean", checkOnSelect : "boolean",
            ...
            {
                pageList : (t.attr("pageList") ? eval(t.attr("pageList")) : undefined), loadMsg : (t.attr("loadMsg") != undefined ? t.attr("loadMsg") : undefined),
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults,
        {
            sharedStyleSheet : false, frozenColumns : undefined, columns : undefined, fitColumns : false,
            resizeHandle : "right", autoRowHeight : true, toolbar : null, striped : false, method : "post",
            nowrap : true, idField : null, url : null, data : null, loadMsg : "Processing, please wait ...",
            emptyMsg : "", rownumbers : false, singleSelect : false, ctrlSelect : false, selectOnCheck : true,
            checkOnSelect : true, pagination : false, pagePosition : "bottom", pageNumber : 1, pageSize : 10,
            pageList : [10, 20, 30, 40, 50], queryParams : {}, sortName : null, sortOrder : "asc", multiSort : false,
            remoteSort : true, showHeader : true, showFooter : false, scrollbarSize : 18, rownumberWidth : 30,
            editorHeight : 24, headerEvents :
        {
            mouseover : _697(true), mouseout : _697(false), click : _69b, dblclick : _6a0, contextmenu : _6a3
        },
            rowEvents :
            {
                mouseover : _6a5(true), mouseout : _6a5(false), click : _6ac, dblclick : _6b6, contextmenu : _6ba
            },
            ...
            loader : function (_854, _855, _856)
            {
                ...
                $.ajax(
                    {
                        type : opts.method, url : opts.url, data : _854, dataType : "json",
                        success : function (data)
                        {
                            _855(data);
                        },
            ...
            editors : _7c4, finder :
        {
            ...
            view : _80d, onBeforeLoad : function (_85e) {}, onLoadSuccess : function () {},
            onLoadError : function () {}, onClickRow : function (_85f, _860) {}, onDblClickRow : function (_861,
                                                                                                           _862) {}, onClickCell : function (_863, _864, _865) {}, onDblClickCell : function (_866, _867,
                                                                                                                                                                                              _868) {}, onBeforeSortColumn : function (sort, _869) {}, onSortColumn : function (sort, _86a) {},
            onResizeColumn : function (_86b, _86c) {}, onBeforeSelect : function (_86d, _86e) {},
            onSelect : function (_86f, _870) {}, onBeforeUnselect : function (_871, _872) {},
            onUnselect : function (_873, _874) {}, onSelectAll : function (rows) {},
            onUnselectAll : function (rows) {}, onBeforeCheck : function (_875, _876) {},
            onCheck : function (_877, _878) {}, onBeforeUncheck : function (_879, _87a) {},
            onUncheck : function (_87b, _87c) {}, onCheckAll : function (rows) {}, onUncheckAll : function (rows) {},
            onBeforeEdit : function (_87d, _87e) {}, onBeginEdit : function (_87f, _880) {},
            onEndEdit : function (_881, _882, _883) {}, onAfterEdit : function (_884, _885, _886) {},
            onCancelEdit : function (_887, _888) {}, onHeaderContextMenu : function (e, _889) {},
...
(function ($)
{
    ...
    function _88e(_88f)
    {
        ...
        $(_88f).datagrid($.extend({}, opts,
            {
                cls : "propertygrid", view : (opts.showGroup ? opts.groupView : opts.view), onBeforeEdit : function (_891,
                                                                                                                     row)
            {
                ...
                onClickCell : function (_892, _893, _894)
                {
                    ...
                    if (opts.editIndex != _892)
                    {
                        ...
                        var ed = $(this).datagrid("getEditor", {
                            index : _892, field : _893
                        });
                        if (!ed) {
                            ed = $(this).datagrid("getEditor", {
                                index : _892, field : "value"
                            });
                        }
                        if (ed)
                        {
    ...
    $.fn.propertygrid = function (_898, _899)
    {
        ...
        return this.each(function ()
        {
            ...
            {
                var opts = $.extend({}, $.fn.propertygrid.defaults, $.fn.propertygrid.parseOptions(this),
                    _898);
                opts.frozenColumns = $.extend(true, [], opts.frozenColumns);
                opts.columns = $.extend(true, [], opts.columns);
    ...
    $.extend(_89d,
        {
            ...
            insertRow : function (_8c8, _8c9, row)
            {
                ...
                {
                    _8cb = {
                        value : row[opts.groupField], rows : [row], startIndex : _8ca.data.rows.length
                    };
    ...
    $.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults,
        {
            groupHeight : 21, expanderWidth : 16, singleSelect : true, remoteSort : false, fitColumns : true,
            loadMsg : "", frozenColumns : [[ {
            ...
            }]], showGroup : false, groupView : _89d, groupField : "group", groupFormatter : function (_8da,
                                                                                                       rows) {
            return _8da;
        }
        });
...
(function ($)
{
    function _8db(_8dc)
    {
        ...
        if (opts.pagination)
        {
            ...
            _8e8.pagination(
                {
                    pageNumber : opts.pageNumber, pageSize : opts.pageSize, pageList : opts.pageList, onSelectPage : function (_8e9,
                                                                                                                               _8ea) {
    ...
    function _957(_958, _959)
    {
        ...
        _952(_958, {
            parent : (_95a ? _95a[opts.idField] : null), data : [_959.data]
        });
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults,
        {
            treeField : null, checkbox : false, cascadeCheck : true, onlyLeafCheck : false, lines : false,
            animate : false, singleSelect : true, view : _97e, rowEvents : $.extend({},$.fn.datagrid.defaults.rowEvents,
            {
                mouseover : _8f6(true), mouseout : _8f6(false), click : _8f8
            }),
            loader : function (_9bc, _9bd, _9be)
            {
                ...
                $.ajax(
                    {
                        type : opts.method, url : opts.url, data : _9bc, dataType : "json",
                        success : function (data)
                        {
                            _9bd(data);
                        },
            ...
            onBeforeLoad : function (row, _9c4) {}, onLoadSuccess : function (row, data) {},
            onLoadError : function () {}, onBeforeCollapse : function (row) {}, onCollapse : function (row) {},
            onBeforeExpand : function (row) {}, onExpand : function (row) {}, onClickRow : function (row) {},
            onDblClickRow : function (row) {}, onClickCell : function (_9c5, row) {},
            onDblClickCell : function (_9c6, row) {}, onContextMenu : function (e, row) {},
            onBeforeEdit : function (row) {}, onAfterEdit : function (row, _9c7) {},
            onCancelEdit : function (row) {}, onBeforeCheckNode : function (row, _9c8) {},
...
(function ($)
{
    function _9ca(_9cb)
    {
        ...
        $(_9cb).datagrid($.extend({}, opts,
            {
                cls : "datalist" + (opts.lines ? " datalist-lines" : ""), frozenColumns : (opts.frozenColumns && opts.frozenColumns.length) ? opts.frozenColumns : (opts.checkbox ? [[ {
    ...
    {
        return $.extend({}, $.fn.datagrid.parseOptions(_9e7), $.parser.parseOptions(_9e7, ["valueField",
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults,
        {
            fitColumns : true, singleSelect : true, showHeader : false, checkbox : false, lines : false, valueField : "value",
            textField : "text", groupField : "", view : _9ce,
...
(function ($)
{
    ...
    function _9ed(_9ee)
    {
        ...
        if (!_9ef.panel)
        {
            ...
            _9ef.panel.panel(
                {
                    minWidth : opts.panelMinWidth, maxWidth : opts.panelMaxWidth, minHeight : opts.panelMinHeight,
                    maxHeight : opts.panelMaxHeight, doSize : false, closed : true, cls : "combo-p", style : {
    ...
    function _a05(_a06)
    {
        ...
        if (_a0a.closed)
        {
            ...
            _a09.panel("resize",
                {
                    width : (opts.panelWidth ? opts.panelWidth : _a08._outerWidth()), height : opts.panelHeight
                });
                ...
                $.data(this, "combo",
                    {
                        options : $.extend(true, {
                            ...
                            $(from).combo("options")), combo : $(this).next(), panel : $(from).combo("panel")
                    });
    ...
    {
        var t = $(_a2e);
        return $.extend({}, $.fn.textbox.parseOptions(_a2e), $.parser.parseOptions(_a2e, ["separator",
                "panelAlign",
                {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults,
        {
            inputEvents : {
                click : _9fe, keydown : _a02, paste : _a02, drop : _a02
            },
            panelWidth : null, panelHeight : 200, panelMinWidth : null, panelMaxWidth : null, panelMinHeight : null,
            panelMaxHeight : null, panelAlign : "left", multiple : false, selectOnNavigation : true, separator : ",",
            hasDownArrow : true, delay : 200, keyHandler :
        {
            up : function (e) {}, down : function (e) {}, left : function (e) {},
            right : function (e) {}, enter : function (e) {}, query : function (q, e) {}
        },
            onShowPanel : function () {}, onHidePanel : function () {}, onChange : function (_a2f, _a30) {}
        });
})(jQuery);
(function ($)
{
    ...
    $.fn.combobox.methods =
    {
        options : function (jq)
        {
            ...
            return $.extend($.data(jq[0], "combobox").options, {
                width : _a73.width, height : _a73.height, originalValue : _a73.originalValue, disabled : _a73.disabled,
    ...
    {
        var t = $(_a79);
        return $.extend({}, $.fn.combo.parseOptions(_a79), $.parser.parseOptions(_a79, ["valueField",
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults,
        {
            valueField : "value", textField : "text", groupPosition : "static", groupField : null,
            groupFormatter : function (_a84)
            {
                return _a84;
            },
            mode : "local", method : "post", url : null, data : null, queryParams : {},
            showItemIcon : false, limitToList : false, view : _a7f, keyHandler :
        {
            up : function (e)
            {
                nav(this, "prev");
            ...
            left : function (e) {}, right : function (e) {},
            enter : function (e)
            {
                _a5c(this);
            },
            ...
            mouseover : _a64, mouseout : _a65, click : _a66, scroll : _a69
        },
            ...
            loader : function (_a86, _a87, _a88)
            {
                ...
                $.ajax(
                    {
                        type : opts.method, url : opts.url, data : _a86, dataType : "json",
                        success : function (data)
                        {
                            _a87(data);
                        },
            ...
            finder :
            {
                ...
                getRow : function (_a93, p)
                {
                    ...
                    var _a95 = (p instanceof $) ? p.attr("id").substr(_a94.itemIdPrefix.length + 1) : _a31(_a93,
                        p);
                    return _a94.data[parseInt(_a95)];
                }
            },
            onBeforeLoad : function (_a96) {}, onLoadSuccess : function () {}, onLoadError : function () {},
            onSelect : function (_a97) {}, onUnselect : function (_a98) {}
        });
})(jQuery);
(function ($)
{
    ...
    $.fn.combotree = function (_ab4, _ab5)
    {
        ...
        return this.each(function ()
        {
            ...
            else
            {
                $.data(this, "combotree",
                    {
                        options : $.extend({}, $.fn.combotree.defaults, $.fn.combotree.parseOptions(this),
                            _ab4)
                    });
            }
            _a99(this);
    ...
    $.fn.combotree.methods =
    {
        options : function (jq)
        {
            ...
            return $.extend($.data(jq[0], "combotree").options, {
                width : _ab8.width, height : _ab8.height, originalValue : _ab8.originalValue, disabled : _ab8.disabled,
        ...
        clone : function (jq, _ab9)
        {
            ...
            t.data("combotree", {
                options : $.extend(true, {}, jq.combotree("options")), tree : jq.combotree("tree")
            });
            return t;
        },
        tree : function (jq)
...
(function ($)
{
    function _abe(_abf)
    {
        ...
        $(_abf).addClass("combogrid-f").combo($.extend({}, opts,
            {
                onShowPanel : function ()
                {
                    ...
                    dg.datagrid("resize",
                        {
                            width : "100%", height : (isNaN(parseInt(opts.panelHeight)) ? "auto" : "100%"), minHeight : (_ac2 ? _ac2 - _ac1 : ""),
        ...
        grid.datagrid($.extend({}, opts,
            {
                border : false, singleSelect : (!opts.multiple), onLoadSuccess : _ac5, onClickRow : _ac6,
                onSelect : _ac7("onSelect"), onUnselect : _ac7("onUnselect"), onSelectAll : _ac7("onSelectAll"),
        ...
        return this.each(function ()
        {
            ...
            else
            {
                _af5 = $.data(this, "combogrid",
                    {
                        options : $.extend({}, $.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this),
                            _af2)
                    });
            }
            _abe(this);
    ...
    $.fn.combogrid.methods =
    {
        options : function (jq)
        {
            ...
            return $.extend($.data(jq[0], "combogrid").options, {
                width : _af6.width, height : _af6.height, originalValue : _af6.originalValue, disabled : _af6.disabled,
                ...
                $.data(this, "combogrid",
                    {
                        options : $.extend(true, {
                            ...
                            $(from).combogrid("options")), combo : $(this).next(), panel : $(from).combo("panel"),
    ...
    {
        var t = $(_afa);
        return $.extend({}, $.fn.combo.parseOptions(_afa), $.fn.datagrid.parseOptions(_afa), $.parser.parseOptions(_afa,
            ["idField", "textField", "mode"]));
    };
    $.fn.combogrid.defaults = $.extend({}, $.fn.combo.defaults, $.fn.datagrid.defaults,
        {
            loadMsg : null, idField : null, textField : null, unselectedValues : [], mappingRows : [], mode : "local",
            keyHandler :
            {
                up : function (e)
                {
...
(function ($)
{
    function _afb(_afc)
    {
        ...
        $(_afc).addClass("combotreegrid-f").combo($.extend({}, opts,
            {
                onShowPanel : function ()
                {
                    ...
                    dg.treegrid("resize",
                        {
                            width : "100%", height : (isNaN(parseInt(opts.panelHeight)) ? "auto" : "100%"), minHeight : (_aff ? _aff - _afe : ""),
        ...
        _afd.grid.treegrid($.extend({}, opts,
            {
                border : false, checkbox : opts.multiple,
        ...
        return this.each(function ()
        {
            ...
            else
            {
                _b18 = $.data(this, "combotreegrid",
                    {
                        options : $.extend({}, $.fn.combotreegrid.defaults, $.fn.combotreegrid.parseOptions(this),
                            _b15)
                    });
            }
            _afb(this);
    ...
    $.fn.combotreegrid.methods =
    {
        options : function (jq)
        {
            ...
            return $.extend($.data(jq[0], "combotreegrid").options, {
                width : _b19.width, height : _b19.height, originalValue : _b19.originalValue, disabled : _b19.disabled,
    ...
    {
        var t = $(_b1d);
        return $.extend({}, $.fn.combo.parseOptions(_b1d), $.fn.treegrid.parseOptions(_b1d), $.parser.parseOptions(_b1d,
            ["mode", {
                limitToGrid : "boolean"
            }]));
    };
    $.fn.combotreegrid.defaults = $.extend({}, $.fn.combo.defaults, $.fn.treegrid.defaults,
        {
            editable : false, singleSelect : true, limitToGrid : false, unselectedValues : [], mappingRows : [],
    ...
    $.fn.datebox.methods =
    {
        options : function (jq)
        {
            ...
            return $.extend($.data(jq[0], "datebox").options, {
                width : _b40.width, height : _b40.height, originalValue : _b40.originalValue, disabled : _b40.disabled,
            ...
            currentText : "Today", closeText : "Close", okText : "Ok", buttons : [
            {
                ...
                handler : function (_b46)
                {
                    ...
                    $(_b46).datebox("calendar").calendar(
                        {
                            year : now.getFullYear(), month : now.getMonth() + 1, current : new Date(now.getFullYear(),
...
(function ($)
{
    ...
    function _b4e(_b4f)
    {
        ...
        return new Date(date.getFullYear(), date.getMonth(), date.getDate(), t.timespinner("getHours"),
            t.timespinner("getMinutes"), t.timespinner("getSeconds"));
    };
        ...
        return this.each(function ()
        {
            ...
            else
            {
                $.data(this, "datetimebox",
                    {
                        options : $.extend({}, $.fn.datetimebox.defaults, $.fn.datetimebox.parseOptions(this),
                            _b5b)
                    });
            }
            _b49(this);
    ...
    $.fn.datetimebox.methods =
    {
        options : function (jq)
        {
            ...
            return $.extend($.data(jq[0], "datetimebox").options, {
                originalValue : _b5f.originalValue, disabled : _b5f.disabled, readonly : _b5f.readonly
            });
        },
        cloneFrom : function (jq, from)
        {
    ...
    {
        var t = $(_b63);
        return $.extend({}, $.fn.datebox.parseOptions(_b63), $.parser.parseOptions(_b63, ["timeSeparator",
            "spinnerWidth", {
                showSeconds : "boolean"
            }]));
    };
...
(function ($)
{
        ...
        function _b7d(aa)
        {
            ...
            for (var i = 0; i < aa.length; i++)
            {
                ...
                if (aa[i] != "|")
                {
                    ...
                    if (opts.mode == "h") {
                        span.css({
                            left : _b7f, marginLeft :- Math.round(span.outerWidth() / 2)
                        });
                    }
                    else {
                        span.css({
                            top : _b7f, marginTop :- Math.round(span.outerHeight() / 2)
                        });
                    }
                }
            }
    ...
    function _b80(_b81)
    {
        ...
        _b83.find("a.slider-handle").draggable(
            {
                axis : opts.mode, cursor : "pointer", disabled : opts.disabled,
                onDrag : function (e)
                {
    ...
    $.fn.slider.parseOptions = function (_ba6)
    {
        ...
        return $.extend({}, $.parser.parseOptions(_ba6, ["width", "height", "mode", {
                reversed : "boolean", showTip : "boolean", range : "boolean", min : "number", max : "number",
                step : "number"
            }]),
            {
    ...
    $.fn.slider.defaults =
    {
        width : "auto", height : "auto", mode : "h", reversed : false, showTip : false, disabled : false,
        range : false, value : 0, separator : ",", min : 0, max : 100, step : 1, rule : [],
        ...
        onChange : function (_ba9, _baa) {}, onSlideStart : function (_bab) {}, onSlideEnd : function (_bac) {},
