...
public class ExcelUtils {
    ...
    public static void readFromExcelDemo() throws IOException {
         ...
         * 读取Excel表中的所有数据
         */
        Workbook workbook = getWeebWork("D:/zfiles/temp/zhaopData.xlsx");
...
//		writeToExcelDemo();
     ...
     */
        ...
        writeExcel("D:/temp/test123456.xlsx", map, wb);//往wb里面写map中内容，生成E:/test1.xlsx这个文件....
    }
}
